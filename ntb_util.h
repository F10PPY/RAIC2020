...
#define COLYELLOW  "\x1B[33m"
#define COLBLUE  "\x1B[34m"
#define COLMAGENTA  "\x1B[35m"
#define COLCYAN  "\x1B[36m"
#define COLWHITE  "\x1B[37m"
...
public:
    inline void resetStats(const size_t n=0)noexcept
    {
    ...
    inline void printStats(const size_t n=0)
    {
        if(n<=total_collections)
        {
    ...
    inline void addSample(const size_t n=0)
    {
        if(n<=total_collections)
        {
