...
extern ntb::Counter <milliseconds> bench;
ai ai;
MyStrategy::MyStrategy() {}

Action MyStrategy::getAction(const PlayerView& playerView, [[maybe_unused]]DebugInterface* debugInterface)
{
    bench.reset();

    ai.updateTick(playerView);
    ai.managerMain();
...
void MyStrategy::debugUpdate([[maybe_unused]] const PlayerView& playerView, DebugInterface& debugInterface)
{
