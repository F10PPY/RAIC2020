...
vw vw;
#endif
ntb::Counter <milliseconds> bench;
class Runner {
public:
...
{
       bench.addCollection("counter");
#ifdef ENABLE_VW
    vw.init();
    vw.createWindow(1600,1000);
    vw.setGlOptions();
    vw.prepareMapTiles();
    vw.prepareMapTilesVAO();
    vw.prepareMapGrid();
    vw.prepareMapGridVAO();
    //vw.prepareMapActions();
    vw.prepareMapActionsVAO();
    vw.prepareText();
    vw.initImGui();
#endif
